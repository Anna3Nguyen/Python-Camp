...
WIDTH, HEIGHT = 900, 500 # controls how big the screen is; SIZE

WIN = pygame.display.set_mode((WIDTH, HEIGHT))

pygame.display.set_caption("Awesome Game!") # NAME of game
...
F16_SPACESHIP_IMAGE = pygame.image.load('plane.jpeg')
