...
def main():
    ...
    SCREEN = pygame.transform.rotate(pygame.transform.scale(SPACE_BACKGROUND, (BACKGROUND_WIDTH, BACKGROUND_HEIGHT)), 45)
    ...
    while True:
        ...
        if keys[pygame.K_RIGHT] and x<900-width: # keeps movement of green block inside size of window
            x += vel
